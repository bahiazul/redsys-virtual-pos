...
//@todo: refactor
class ValidatorMultipleParameterTest extends PHPUnit_Framework_TestCase
{
    public $test_data;
    ...
    public function testValidValidation()
    {
        ...
        $validation = \nkm\RedsysVirtualPos\Validation\Validator::validate($this->test_data, $rules);
    ...
    public function testInvalidValidation()
    {
        ...
        $validation = \nkm\RedsysVirtualPos\Validation\Validator::validate($this->test_data, $rules, $naming);
